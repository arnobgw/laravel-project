...
<div class="container">
  ...
  <form action="{{route('religion.store')}}" method="POST">
    {{ csrf_field() }}
    <input type="hidden" name="inputReligionID" class="form-control ii">

    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>Existing Religion :</label>
        </div>        
        <div class="col-sm-4">
          <select name="setValue" class="selectpicker sl" data-live-search="true" id="select" data-size="6" autofocus>
            <option selected disabled hidden style='display: none' value=''></option>
            @foreach ($religions as $religion)
            <option>{{ $religion->religionName }}</option>
            @endforeach
          </select>
        </div> 
      </div>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-sm-6">
          <input type="text" name="inputReligionName" autocomplete="no"
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>Religion Name (In Bangla) :</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="inputReligionNameBangla" autocomplete="no"
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>Religion Priority Serial :</label>
        </div>
        <div class="col-sm-2">
          <input type="number" name="inputReligionPriority" min="1" autocomplete="no"
