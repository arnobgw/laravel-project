...
<div class="container">
  ...
  <hr>
  <br>
  <form action="{{route('sdepartment.store')}}" method="POST">
    {{ csrf_field() }}
    <input type="hidden" name="inputSubDepartmentID" class="form-control ii">

    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>Existing Sub Department :</label>
        </div>        
        <div class="col-sm-4">
          <select name="setValue" class="selectpicker sl" data-live-search="true" id="select" data-size="6" autofocus>
            <option selected disabled hidden style='display: none' value=''></option>
            @foreach ($subDepartments as $subDepartment)
            <option>{{ $subDepartment->subDepartmentName }}</option>
            @endforeach
          </select>
        </div> 
      </div>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-sm-6">
          <input type="text" name="inputSubDepartmentName" autocomplete="no"
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>SubDepartment Name (In Bangla):</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="inputSubDepartmentNameBangla" autocomplete="no"
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>SubDepartment Priority Serial:</label>
        </div>
        <div class="col-sm-2">
          <input type="number" name="inputSubDepartmentPriority" min="1" autocomplete="no"
