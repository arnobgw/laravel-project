...
<div class="container">
  ...
  <hr>
  <br>
  <form action="{{route('sex.store')}}" method="POST">
    {{ csrf_field() }}
    <input type="hidden" name="inputSexID" class="form-control ii">

    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>Existing Sex :</label>
        </div>        
        <div class="col-sm-4">
          <select name="setValue" class="selectpicker sl" data-live-search="true" id="select" data-size="6" autofocus>
            <option selected disabled hidden style='display: none' value=''></option>
            @foreach ($sexes as $sex)
            <option>{{ $sex->sexName }}</option>
            @endforeach
          </select>
        </div> 
      </div>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-sm-6">
          <input type="text" name="inputSexName" autocomplete="no"
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>Sex Name (In Bangla):</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="inputSexNameBangla" autocomplete="no"
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>Sex Priority Serial:</label>
        </div>
        <div class="col-sm-2">
          <input type="number" name="inputSexPriority" min="1" autocomplete="no"
