...
<div class="container">
  ...
  <hr>
  <br>
  <form action="{{route('otstatus.store')}}" method="POST">
    {{ csrf_field() }}
    <input type="hidden" name="inputOTStatusID" class="form-control ii">

    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>Existing OT Status :</label>
        </div>        
        <div class="col-sm-4">
          <select name="setValue" class="selectpicker sl" data-live-search="true" id="select" data-size="6" autofocus>
            ...
            <option>{{ $otStatus->otStatusName }}</option>
            @endforeach
          </select>
        </div> 
      </div>
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>OT Status Name :</label>
        </div>        
        <div class="col-sm-6">
          <input type="text" name="inputOTStatusName" autocomplete="no"
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>OT Status Name (In Bangla) :</label>
        </div>
        <div class="col-sm-6">
          <input type="text" name="inputOTStatusNameBangla" autocomplete="no"
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-4">
          <label>OT Status Priority Serial :</label>
        </div>
        <div class="col-sm-2">
          <input type="number" name="inputOTStatusPriority" min="1" autocomplete="no"
